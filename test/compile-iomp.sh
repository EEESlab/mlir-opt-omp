...
#mlir-opt test-s2.mlir   --canonicalize   --cse   --sccp   --symbol-dce   --remove-dead-values   --loop-invariant-code-motion   --canonicalize   --cse   --convert-arith-to-llvm   --convert-func-to-llvm   --reconcile-unrealized-casts   -o test-s3.mlir
