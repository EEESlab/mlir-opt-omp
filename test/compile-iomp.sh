...
clang -S -Xclang -fclangir -Xclang -emit-cir -fopenmp  -I/usr/lib/gcc/x86_64-linux-gnu/12/include $SRCFILE -o test.cir
...
clang -O3 -c $SRCMAIN -o main.o
clang -O3 -fopenmp test.o main.o -o test

# Reference
clang -O3 -fopenmp  -I/usr/lib/gcc/x86_64-linux-gnu/12/include $SRCFILE $SRCMAIN  -o test-ref
