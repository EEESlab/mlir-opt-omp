module @"/home/tagliavini/MLIR/grammar/mlir-transform/test/test2.c" attributes {dlti.dl_spec = #dlti.dl_spec<!llvm.ptr<270> = dense<32> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, "dlti.endianness" = "little", "dlti.mangling_mode" = "e", "dlti.legal_int_widths" = array<i32: 8, 16, 32, 64>, "dlti.stack_alignment" = 128 : i64>, llvm.module_asm = [], llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  llvm.func @outlined_parallel_0(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: !llvm.ptr, %arg4: !llvm.ptr, %arg5: !llvm.ptr, %arg6: !llvm.ptr, %arg7: !llvm.ptr, %arg8: !llvm.ptr, %arg9: !llvm.ptr, %arg10: !llvm.ptr) attributes {sym_visibility = "private"} {
    ...
    llvm.call @__kmpc_for_static_init_4(%14, %16, %25, %23, %20, %21, %22, %13, %26) : (!llvm.ptr, i32, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, i32, i32) -> ()
  ...
  ^bb19:  // pred: ^bb18
    ...
    llvm.br ^bb1
  ^bb20:  // pred: ^bb1
    llvm.call @__kmpc_for_static_fini(%14, %16) : (!llvm.ptr, i32) -> ()
    llvm.call @__kmpc_barrier(%14, %16) : (!llvm.ptr, i32) -> ()
    llvm.return
  }
  ...
  llvm.func @gemm(%arg0: f64, %arg1: f64, %arg2: !llvm.ptr, %arg3: !llvm.ptr, %arg4: !llvm.ptr) attributes {dso_local, no_inline} {
    ...
    %18 = llvm.call @__kmpc_global_thread_num(%17) : (!llvm.ptr) -> i32
    %19 = llvm.mlir.constant(7 : i32) : i32
    %20 = llvm.mlir.addressof @outlined_parallel_0 : !llvm.ptr
    llvm.call @__kmpc_fork_call(%17, %19, %20, %13, %15, %3, %9, %1, %5, %7) : (!llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) -> ()
    llvm.return
  }
  llvm.func @__kmpc_global_thread_num(!llvm.ptr) -> i32 attributes {sym_visibility = "private"}
  llvm.func @__kmpc_fork_call(!llvm.ptr, i32, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr, !llvm.ptr) attributes {sym_visibility = "private"}
